...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    ...
    public class OwnershipHandler : MonoBehaviourPun, IPunOwnershipCallbacks, IMixedRealityInputHandler
    {
        ...
        public void OnOwnershipTransferFailed(PhotonView targetView, Photon.Realtime.Player sender)
        {
            // Dibiarkan kosong saja tidak apa-apa, ini hanya untuk memenuhi syarat sistem Photon baru
        }
    }
}
