    ...
    private void CloudManager_AnchorLocated(object sender, AnchorLocatedEventArgs args)
    {
        ...
        if (args.Status == LocateAnchorStatus.Located || args.Status == LocateAnchorStatus.AlreadyTracked)
        {
            ...
            QueueOnUpdate(() =>
            {
                ...
                // FIX: Menggunakan ekstraksi Pose modern sebagai pengganti WSA.WorldAnchor yang usang di Unity modern.
                if (currentCloudAnchor != null)
                {
                    ...
                    Debug.Log("Local anchor position successfully set to Azure anchor position via Pose");
                }
